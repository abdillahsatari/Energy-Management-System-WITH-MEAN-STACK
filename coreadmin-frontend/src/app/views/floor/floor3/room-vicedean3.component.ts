...
@Component({
  templateUrl: 'room-vicedean3.component.html'
})
export class RoomViceDean3Component implements OnInit, OnDestroy {
  ...
  fetchDataItem(){
    ...
    let content5 = document.getElementById("lampFour");
    let content6 = document.getElementById("external_ac");
     ...
     this._activeRoute.params.subscribe(params => {
      ...
      if (this.datastatus[3].status == "1"){
          ...
          console.log("lamp_1_external_On");
         }
         else{
    ...
    // check the data and give a class active if the data is 1 to change the color
      if (this.datastatus[4].status == "1"){
          ...
          console.log("lamp_2_external_On");
         }
         else{
         ...
         // check the data and give a class active if the data is 1 to change the color
      if (this.datastatus[5].status == "1"){
          content6.setAttribute('class','active');
          console.log("Ac_External_On");
         }
         else{
           content6.setAttribute('class',"");
            console.log("Ac_External_On")
         }    
         // endOfIF
      });
